...
def main(vodID: str, so: int):
    ...
    if os == 0:
        comando_comp = "winrar.exe a -afrar -df -m5 -mt3 -ri15 -t -tk -ts "
        comando_conv = "ffmpeg.exe"
        nom_ejec = "WinRAR.exe"
    else:
        comando_comp = "./rar a -df -m5 -mt3 -t -tk -ts "
        comando_conv = "./ffmpeg"
        nom_ejec = "RAR"

    os.system("echo -------------------------------------------------")
    os.system("echo Ejecutando FFMPEG")
    os.system("echo Comando:")
    os.system('echo ' + comando_conv + ' -y -i "' + nom_vid + '.ts" -c:v copy -c:a copy "' + nom_vid + '.mp4"')
    os.system(comando_conv + ' -y -i "' + nom_vid + '.ts" -c:v copy -c:a copy "' + nom_vid + '.mp4"')
    os.system("echo -------------------------------------------------")
    ...
    os.system("echo -------------------------------------------------")
    os.system("echo Comprimiendo archivo MP4. Ejecutando " + nom_ejec)
    os.system("echo Comando:")
    
    os.system("mkdir " + vodID)
    os.system('echo ' + comando_comp + '-v1.9g ".\\' + vodID + '\\' + nom_vid + '.rar" "' + nom_vid + '.mp4"')
    os.system(comando_comp + '-v1.9g ".\\' + vodID + '\\' + nom_vid + '.rar" "' + nom_vid + '.mp4"')
